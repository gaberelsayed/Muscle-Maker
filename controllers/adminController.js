...
exports.postEditMeal = async (req, res, next) => {
  ...
  try {
    ...
    meal.options = options.length > 0 ? options : meal.options;
    meal.extras = extras.length > 0 ? extras : meal.extras;
    meal.allowedExtras = allowedExtras > 0 ? allowedExtras : meal.allowedExtras;
    await meal.save();
    res
      .status(201)
